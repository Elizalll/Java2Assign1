...
public class MovieAnalyzerLocalTest {
    ...
    void testGetTopStarsRatingWithoutOrder() {
        try {
            ...
            System.out.println("___res1___\n" + ((List<?>) res1).size() + res1);
            System.out.println("___expected1___\n" + expected1.length() + expected1);
            assertTrue(compareListWithoutOrder(res1, expected1));
...
//            System.out.println("___res2___\n" + ((List<?>) res2).size() + res2);
//            System.out.println("___expected2___\n" + expected2.length() + expected2);
            assertTrue(compareListWithoutOrder(res2, expected2));
